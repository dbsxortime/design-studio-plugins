---
name: design-tokens
description: 프로젝트 디자인 기준(.design/tokens.json) 확보 — 기존 시스템 토큰화 / 페이지 분석 / 채팅 온보딩 3경로. 트리거 — "디자인 토큰 만들어", "기준 잡자", "primary 정하자", "/design-tokens".
---
...
그 값을 기준 후보로 최우선 반영한다. 없으면 아래 3경로로 진행 (라이트 동작).
